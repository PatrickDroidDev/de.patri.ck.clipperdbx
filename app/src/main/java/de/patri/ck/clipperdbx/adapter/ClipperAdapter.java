...
public class ClipperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

  ArrayList<Clipper> itemList;
  Context context;
  String clpr_type;

  public ClipperAdapter(Context context, ArrayList<Clipper> itemList) {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_clipper, parent, false);
  ...
  public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
	...
	String img_url = Config.IMG_URL+"/sets/"+itemList.get(position).getImage()+".png";
    ...
    imgLoader.get(img_url, ImageLoader.getImageListener(((ClipperHolder) holder).setImage, R.drawable.load, R.drawable.clipperdb_blank));
  ...
  public class ClipperHolder extends RecyclerView.ViewHolder {
    ...
    public ClipperHolder(View itemView) {
      ...
      itemView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
          ((Main) view.getContext()).onClipperSelect(itemList.get(getAdapterPosition()).getSetId());
        }
      });
    }
  }
  ...
  private static @NonNull RequestQueue newRequestQueue(@NonNull Context context) {
