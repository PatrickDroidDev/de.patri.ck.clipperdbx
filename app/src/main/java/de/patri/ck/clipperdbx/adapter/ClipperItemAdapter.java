...
public class ClipperItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	
	ArrayList<Clipper> itemList;
	Context context;
	String clpr_type;
	
	public ClipperItemAdapter(Context context, ArrayList<Clipper> itemList) {
