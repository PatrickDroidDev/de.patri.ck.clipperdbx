...
import de.patri.ck.clipperdbx.Debug;
  ...
  public void onCreate() {
    ...
    Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
      ...
      public void uncaughtException(Thread thread, Throwable ex) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(getApplicationContext(), 11111, intent, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_MUTABLE);
    ...
    super.onCreate();
    cache = new LruBitmapCache(LruBitmapCache.getDefaultLruCacheSize());
  }
